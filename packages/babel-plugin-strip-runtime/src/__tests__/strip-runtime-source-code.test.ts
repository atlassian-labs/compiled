...
const transformSync = (code: string, opts: TransformOptions): BabelFileResult | null => {
...
const transform = (c: string, opts: TransformOptions): string => {
...
describe('babel-plugin-strip-runtime using source code', () => {
  ...
  describe('when run in the same step', () => {
    ...
    describe('with jsx pragma', () => {
      ...
      it("errors when emotion's classic jsx pragma is mixed with compiled", () => {
        const codeWithPragma = `
          /** @jsx jsx */
