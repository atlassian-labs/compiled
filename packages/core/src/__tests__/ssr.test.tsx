...
describe('SSR', () => {
  ...
  it('should render style tags in buckets', () => {
    ...
    expect(result.split('</style>').join('</style>\n')).toMatchInlineSnapshot(`
      ...
      <style data-cl=\\"\\" nonce=\\"k0Mp1lEd\\">._ysv75scu:link{color:red}</style>
      <style data-cv=\\"\\" nonce=\\"k0Mp1lEd\\">._105332ev:visited{color:pink}</style>
      <style data-cf=\\"\\" nonce=\\"k0Mp1lEd\\">._f8pjbf54:focus{color:green}</style>
      <style data-ch=\\"\\" nonce=\\"k0Mp1lEd\\">._30l31gy6:hover{color:yellow}</style>
      <style data-ca=\\"\\" nonce=\\"k0Mp1lEd\\">._9h8h13q2:active{color:blue}</style>
      <style data-cm=\\"\\" nonce=\\"k0Mp1lEd\\">@supports (display: grid){._qxnw1gy6:focus{color:yellow}._p7tw11x8:active{color:black}}@media (max-width: 800px){._vyxz1gy6:focus{color:yellow}._ojvu11x8:active{color:black}}</style>
