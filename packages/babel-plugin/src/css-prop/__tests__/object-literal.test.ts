...
describe('css prop object literal', () => {
  ...
  it('should correctly expand shorthand property with ternary expression', () => {
    ...
    expect(actual).toMatchInlineSnapshot(`
      "import React from'react';import{ax,ix,CC,CS}from"@compiled/react/runtime";const _4="._19bv1ylp{padding-left:40px}";const _3="._n3td1ul9{padding-bottom:30px}";const _2="._u5f3gktf{padding-right:20px}";const _="._ca0q19bv{padding-top:10px}";const morePadding=true;<CC>
          <CS>{[_,_2,_3,_4]}</CS>
