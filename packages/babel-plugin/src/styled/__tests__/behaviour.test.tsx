...
describe('styled component behaviour', () => {
  ...
  it('should handle destructuring in interpolation functions', () => {
    ...
    expect(actual).toMatchInlineSnapshot(`
      "/* File generated by @compiled/babel-plugin v0.0.0 */import{forwardRef}from'react';import*as React from'react';import{ax,ix,CC,CS}from\\"@compiled/react/runtime\\";import colors from'colors';const _6=\\"._1h6d1qzc{border-color:var(--_96ptk)}\\";const _5=\\"._1h6d1c5w{border-color:var(--_5rpikm)}\\";const _4=\\"._syazs2l2{color:var(--_1oii75x)}\\";const _3=\\"._syaz1c44{color:var(--_1ytezyk)}\\";const _2=\\"._bfhk1lco{background-color:var(--_kcgnsd)}\\";const _=\\"._bfhkhk3l{background-color:var(--_16ldrz5)}\\";export const BadgeSkeleton=forwardRef(({as:C=\\"span\\",style,isLoading,loading:l,...props},ref)=><CC>
            <CS>{[_,_2,_3,_4,_5,_6]}</CS>
            <C{...props}style={{...style,\\"--_16ldrz5\\":ix(colors.N20),\\"--_kcgnsd\\":ix(colors.N40),\\"--_1ytezyk\\":ix(colors.N50),\\"--_1oii75x\\":ix(colors.N10),\\"--_5rpikm\\":ix(colors.N100),\\"--_96ptk\\":ix(colors.N200)}}ref={ref}className={ax([\\"\\",isLoading?\\"_bfhkhk3l\\":\\"_bfhk1lco\\",l?\\"_syaz1c44\\":\\"_syazs2l2\\",propz.loading?\\"_1h6d1c5w\\":\\"_1h6d1qzc\\",props.className])}/>
