...
describe('styled component behaviour', () => {
  ...
  it('should handle destructuring in interpolation functions', () => {
    ...
    expect(actual).toMatchInlineSnapshot(`
      "/* File generated by @compiled/babel-plugin v0.0.0 */import*as React from'react';import{ax,CC,CS}from\\"@compiled/react/runtime\\";import colors from'colors';const _=\\"._bfhk1brv{background-color:var(--_140mev0)}\\";export const BadgeSkeleton=React.forwardRef(({as:C=\\"span\\",style,loading,...props},ref)=><CC>
            <CS>{[_]}</CS>
            <C{...props}style={{...style,\\"--_140mev0\\":loading?colors.N20:colors.N40}}ref={ref}className={ax([\\"_bfhk1brv\\",props.className])}/>
          </CC>);"
    `);
  });
});
