...
describe('styled-components-to-compiled imports transformer', () => {
  ...
  defineInlineTest(
    ...
    'it transforms trailing comment lines when comments are inline'
  );
  ...
  defineInlineTest(
    ...
    'it transforms trailing comment blocks when comments are inline'
  );
  ...
  defineInlineTest(
    ...
    `,
    'it transforms leading comment blocks when comments are inline'
  );
  ...
  defineInlineTest(
    ...
    `,
    'it transforms leading comment lines when comments are inline'
  );
  ...
  defineInlineTest(
    ...
    'it transforms trailing comment lines with multiple named imports when comments are inline'
  );
  ...
  defineInlineTest(
    ...
    `,
    'it transforms leading comment lines with multiple named imports when comments are inline'
  );
  ...
  defineInlineTest(
    ...
    `,
    'it transforms comments for default imports when comments are inline'
  );
  ...
  defineInlineTest(
    ...
    `,
    'it transforms leading comment blocks for default imports when comments are inline'
  );
