...
\`;
  ...
  defineInlineTest(
    ...
    export const Input = props => <CompiledInput id={'test-id'} onClick={props.onClick} {...props} />;
    `,
...
\`;
    ...
    export const Input = props => isFeatureFlagEnabled() ? <CompiledInput id={'test-id'} onClick={this.onClick} {...props} /> : null;
    `,
