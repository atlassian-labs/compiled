 ...
 */
function lazyAddStyleBucketToHead(bucketName: Bucket): HTMLStyleElement {
 ...
 * @param css string
 */
export default function insertRule(css: string): void {
  const bucketName = getStyleBucketName(css);
  const style = lazyAddStyleBucketToHead(bucketName);
