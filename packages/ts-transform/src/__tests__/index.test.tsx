...
describe('root transformer', () => {
  ...
  it('should transform a styled component', () => {
    ...
    expect(actual.outputText).toMatchInlineSnapshot(`
      ...
      React.forwardRef(({ as, ...props }, ref) => <><Style hash=\\"css-1x3e11p\\">{[\\".css-1x3e11p{font-size:12px;}\\"]}</Style><(as || \\"div\\") {...props} ref={ref} className={\\"css-1x3e11p\\" + (props.className ? \\" \\" + props.className : \\"\\")}/></>);
      "
    `);
  });
