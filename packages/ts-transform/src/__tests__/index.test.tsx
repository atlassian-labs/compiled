...
describe('root transformer', () => {
  ...
  it('should transform a styled component', () => {
    ...
    expect(actual.outputText).toMatchInlineSnapshot(`
      ...
      React.forwardRef(({ as: C = \\"div\\", ...props }, ref) => <><Style hash=\\"1x3e11p\\">{[\\".1x3e11p{font-size:12px;}\\"]}</Style><C {...props} ref={ref} className={\\"1x3e11p\\" + (props.className ? \\" \\" + props.className : \\"\\")}/></>);
      "
    `);
  });
  ...
  it('should transform css prop', () => {
    ...
    expect(actual.outputText).toMatchInlineSnapshot(`
      "import React from \\"react\\";
      import { Style } from '@compiled/css-in-js';
      <><Style hash=\\"1iqe21w\\">{[\\".1iqe21w{font-size:12px;}\\"]}</Style><div className=\\"1iqe21w\\"/></>;
      "
    `);
  });
  ...
  it('should transform classnames component', () => {
    ...
    expect(actual.outputText).toMatchInlineSnapshot(`
      "import React from \\"react\\";
      import { Style } from '@compiled/css-in-js';
      <><Style hash=\\"d70zot\\">{[\\".1iqe21w{font-size:12px;}\\"]}</Style><div className={\\"1iqe21w\\"}/></>;
      "
    `);
  });
});
