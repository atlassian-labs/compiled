...
// use swc_core::common::atoms::Atom; // not available in this version
use swc_core::common::comments::Comments;
use swc_core::common::util::take::Take;
use swc_core::common::{BytePos, SourceMapper, DUMMY_SP, SyntaxContext};
use swc_core::ecma::ast::{
    ArrayLit, CallExpr, JSXAttr, JSXAttrName, JSXAttrOrSpread, JSXAttrValue, JSXElementName,
    JSXExpr, JSXExprContainer, JSXObject, Callee, Expr, ExprOrSpread, Id, Ident, IdentName, 
    ImportDecl, ImportSpecifier, JSXElement, KeyValueProp, MemberProp, ObjectLit, Pat, Prop, 
    PropName, PropOrSpread, Tpl, VarDeclarator,
};
use swc_core::ecma::utils::ExprFactory;
use swc_core::ecma::visit::{Fold, FoldWith};
use swc_core::ecma::ast::SourceMapperExt;
...
// #[swc_trace] - not available in this swc_core version
                                    ...
                                    if let MemberProp::Ident(prop) = &m.prop {
                                        ...
                                        return CallExpr {
                                            ...
                                            callee: CallExpr {
                                                ...
                                                ctxt: SyntaxContext::empty(),
                                                type_args: None,
                                                callee: Ident::new(i.sym.clone(), i.span, SyntaxContext::empty())
                                                    .as_callee(),
                                                args,
                                            }
                                            .as_callee(),
