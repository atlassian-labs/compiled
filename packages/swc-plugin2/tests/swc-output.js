...
async function transform(code, options = {}) {
  ...
  const enablePlugin = (options.forceEnable !== undefined)
    ? !!options.forceEnable
  ...
  const swcOptions = {
    ...
    jsc: {
      ...
      experimental: enablePlugin ? { plugins: [[wasmPath, (()=>{
        const extra = pluginOptions && pluginOptions.extractStylesToDirectory ? {
          filename: 'test.tsx',
