...
/**
 * Inserts a non-atomic CSS rule (e.g. a `cc-` prefixed rule generated by `cssMap` with
 * `atomic: false`) into the catch-all style bucket, bypassing the shorthand bucket
 * sorting logic in `getStyleBucketName`.
 *
