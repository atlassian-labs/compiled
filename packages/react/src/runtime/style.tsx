 ...
 * `cssMap` with `atomic: false`. Non-atomic rules use the `cc-` class prefix
  ...
  if (props.children.length) {
    if (isServerEnvironment()) {
      ...
      for (let i = 0; i < props.children.length; i++) {
        ...
        // Non-atomic rules (cc- prefix from cssMap with atomic: false) must go into
      ...
      for (let i = 0; i < props.children.length; i++) {
        ...
        // Non-atomic rules (cc- prefix from cssMap with atomic: false) must bypass the
