...
describe('browser', () => {
  ...
  it('should render style tags in buckets', () => {
    ...
    expect(document.head.innerHTML.split('</style>').join('</style>\n')).toMatchInlineSnapshot(`
      "<style nonce=\\"k0Mp1lEd\\">._1e0c1txw{display:flex}._1wyb12am{font-size:50px}._syaz1cnh{color:purple}._ysv71x77:link, ._v0vw1x77:focus-visible{color:white}</style>
      ...
      <style nonce=\\"k0Mp1lEd\\">@supports (display: grid){._qxnw1gy6:focus{color:yellow}._p7tw11x8:active{color:black}}@media (max-width: 800px){._vyxz1gy6:focus{color:yellow}._7zyjtwqo:hover, ._ov6atwqo:focus-visible{color:grey}._ojvu11x8:active{color:black}}</style>
      "
    `);
  });
});
